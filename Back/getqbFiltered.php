  ...
  //this file filters based on a a given category, description, and keyword
  ...
  //database select
  $sql = "SELECT * FROM QUESTION_BANK WHERE teacher_id = $teacher_id AND category = $category AND difficulty = $difficulty AND (description LIKE '%$keyword%' OR function_name LIKE '%$keyword%') ORDER BY question_id ASC;";
  ...
  for($i = 0; $i < $result->num_rows; $i++){
    ...
    //add in con_temp to return array once we're sure it wont break anything
